        ...
        <section class="content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-3">
                        <a href="{{route('admin.category.destroy',['id'=>$data->id])}}" onclick="return confirm('Deleting !! Are you sure ?')" class="btn btn-outline-secondary btn-danger btn-icon-text" style="width: 200px">Delete</a>
                    </div>
                    <div class="col-sm-6">
